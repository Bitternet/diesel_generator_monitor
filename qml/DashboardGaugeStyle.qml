...
CircularGaugeStyle {
    ...
    function paintBackground(ctx) {
        ...
        ctx.ellipse(0, 0, ctx.canvas.width, ctx.canvas.height, 0, Math.PI * 2);
        ctx.fill();
    ...
    needle: Canvas {
        ...
        onPaint: {
            ...
            ctx.closePath();
            ctx.fillStyle = Qt.rgba(0.66, 0, 0, 1);
            ctx.fill();
            ...
            ctx.lineTo(xCenter, 0);
            ctx.closePath();
            ctx.fillStyle = Qt.lighter(Qt.rgba(0.66, 0, 0, 1));
            ctx.fill();
        }
    }
